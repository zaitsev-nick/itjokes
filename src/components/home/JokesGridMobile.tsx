...
export default function JokesGridMobile() {
  ...
  const showMore = 
    <a href="#"  className="relative">
      ...
      <span className="fold-bold relative inline-block h-full w-full rounded border-2 border-black bg-black px-6 py-2 text-base font-bold text-white transition duration-100 hover:bg-gray-900 hover:text-yellow-500">Show more</span>
    </a>
  ;
